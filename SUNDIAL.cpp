...
int SolverLibrary::solve_with_sundials(std::vector<double>& y_initial, double t0, double tf, double dt_unused, std::vector<std::vector<double>>& trajectory)
{
